...
Garfield.addXnodes({pattern: 'fb ?(.*)', fromMe: wk, desc: CLR_DESC, usage: 'fb https://www.facebook.com/Google/videos/10156367314197838'}, (async (message, match) => {
  ...
  var payload = await AuroraX.facebook(match[1])
  var auth_message = await AuroraX.facebook_message(Config.LANG)
