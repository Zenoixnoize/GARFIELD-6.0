...
if (Config.WORKTYPE == 'private') {
    ...
    Garfield.addXnodes({pattern: 'anime', fromMe: true, desc: 'random anime image'}, (async (message, match) => {
