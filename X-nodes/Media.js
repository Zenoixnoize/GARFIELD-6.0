...
if (Config.WORKTYPE == 'private') {
    ...
    Garfield.addXnodes({pattern: 'mp4image', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Garfield.addXnodes({pattern: 'spectrum', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Garfield.addXnodes({pattern: 'waves', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Garfield.addXnodes({pattern: 'frequency', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Garfield.addXnodes({pattern: 'avec', fromMe: false, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Garfield.addXnodes({pattern: 'volumeaudio', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Garfield.addXnodes({pattern: 'cqtaudio', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Garfield.addXnodes({pattern: 'mp3reverse', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Garfield.addXnodes({pattern: 'blurimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Garfield.addXnodes({pattern: 'mp4edge', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Garfield.addXnodes({pattern: 'edgeimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Garfield.addXnodes({pattern: 'enhanceimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Garfield.addXnodes({pattern: 'gif', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Garfield.addXnodes({pattern: 'agif', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
    ...
    Garfield.addXnodes({pattern: 'grenimage', fromMe: false, dontAddCommandList: true}, (async (message, match) => {   
    ...
    Garfield.addXnodes({pattern: 'mp4slowmo', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
