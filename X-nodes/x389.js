...
if (Config.WORKTYPE == 'private') {
    ...
    Garfield.addXnodes({pattern: 'wallpaper', fromMe: true, desc: Lang.WP}, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid, Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: ' ```Follow Us Facebook - https://www.facebook.com/garfieldbots/``` '})

    }));
}
else if (Config.WORKTYPE == 'public') {

    Garfield.addXnodes({pattern: 'wallpaper', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    Garfield.addXnodes({pattern: 'wallpaper', fromMe: true, desc: Lang.WP, dontAddCommandList: true}, (async (message, match) => {
