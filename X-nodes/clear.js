...
Garfield.addXnodes({pattern: 'clear', fromMe: true, desc: END, dontAddCommandList: true}, (async (message, match) => {
...
Garfield.addXnodes({pattern: 'clean ?(.*)', fromMe: true, desc: END, dontAddCommandList: true}, (async (message, match) => {
