...
if (Config.WORKTYPE == 'private') {
    ...
    Garfield.addXnodes({pattern: 'unvoice', fromMe: true, desc: Lang.UV_DESC}, (async (message, match) => {    
    ...
    Garfield.addXnodes({pattern: 'unvoice', fromMe: false, desc: Lang.UV_DESC}, (async (message, match) => {    
    ...
    Garfield.addXnodes({pattern: 'unvoice', fromMe: true, desc: Lang.UV_DESC, dontAddCommandList: true}, (async (message, match) => {    
