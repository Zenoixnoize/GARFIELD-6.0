...
if (conf.WORKTYPE == 'private') {
    ...
    Garfield.addXnodes({ pattern: 'voicy', desc: Lang.USAGE, fromMe: true }, (async (message, match) => {
...
if (conf.WORKTYPE == 'public') {
    ...
    Garfield.addXnodes({ pattern: 'voicy', desc: Lang.USAGE, fromMe: false }, (async (message, match) => {
