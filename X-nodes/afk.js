...
Garfield.addXnodes({on: 'text', fromMe: true, deleteCommand: false}, (async (message, match) => {
...
Garfield.addXnodes({pattern: 'afk ?(.*)', fromMe: true, deleteCommand: false, desc: Lang.AFK_DESC}, (async (message, match) => {     
    if (!AFK.isAfk) {
