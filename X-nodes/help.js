...
if (Config.LANG == 'TR' || Config.LANG == 'AZ') {
    ...
    Garfield.addXnodes({pattern: 'help ?(.*)', fromMe: true, desc: h_Des}, (async (message, match) => {
    ...
    Garfield.addXnodes({pattern: 'help ?(.*)', fromMe: true, desc: h_DedEN}, (async (message, match) => {
