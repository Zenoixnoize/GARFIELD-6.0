...
Garfield.addXnodes({pattern: 'tagall ?(.*)', fromMe: true, desc: Lang.TAGALL_DESC }, (async (message, match) => {
...
Garfield.addXnodes({pattern: 'stam$', fromMe: true, desc: stag_dsc }, (async (message, match) => {
