...
Garfield.addXnodes({pattern: 'tag ?(.*)', fromMe: true, dontAddCommandList: true, desc: Lang.TAGALL_DESC }, (async (message, match) => {
...
async function checkImAdmin(message, user = message.client.user.jid) {
    ...
    Garfield.addXnodes({pattern: 'tag ?(.*)', fromMe: false, dontAddCommandList: true, desc: Lang.TAGALL_DESC }, (async (message, match) => {
    ...
    if (!message.reply_message) {
     ...
     Garfield.addXnodes({pattern: 'report ?(.*)', fromMe: false, desc: 'to report someone'}, (async (message, match) => {
        if (match[1] == '') {
