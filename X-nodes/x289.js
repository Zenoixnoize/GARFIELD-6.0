...
if (config.WORKTYPE == 'private') {
    ...
    Garfield.addXnodes({pattern: 'ccccc(?: |$)(\\S*) ?(\\S*)', desc: Lang.TRANSLATE_DESC, usage: Lang.TRANSLATE_USAGE, fromMe: true}, (async (message, match) => {
    ...
    Garfield.addXnodes({pattern: 'antilink ?(.*)', fromMe: true, desc: l_dsc, usage: '.antilink on / off' }, (async (message, match) => {
    ...
    Garfield.addXnodes({pattern: 'dettlng$', fromMe: true, desc: dlang_dsc}, (async (message, match) => {
    ...
    if (config.LANG == 'TR' || config.LANG == 'AZ') {
        ...
        Garfield.addXnodes({pattern: 'zbshss (.*)', fromMe: true, desc: Lang.TTS_DESC}, (async (message, match) => {
    ...
    Garfield.addXnodes({pattern: 'play ?(.*)', fromMe: true, desc: Lang.SONG_DESC}, (async (message, match) => { 
    ...
    Garfield.addXnodes({pattern: 'vijdjo ?(.*)', fromMe: true, desc: Lang.VIDEO_DESC}, (async (message, match) => { 
    ...
    Garfield.addXnodes({pattern: 'ythsh ?(.*)', fromMe: true, desc: Lang.YT_DESC}, (async (message, match) => { 
    ...
    Garfield.addXnodes({pattern: 'wjdjdki ?(.*)', fromMe: true, desc: Lang.WIKI_DESC}, (async (message, match) => { 
    ...
    Garfield.addXnodes({pattern: "xxxxx ?(.*)", fromMe: true, desc: Clang.COV_DESC}, (async (message, match) => {
        if (match[1] === "") {
            try{
    ...
    Garfield.addXnodes({pattern: 'ccccc(?: |$)(\\S*) ?(\\S*)', desc: Lang.TRANSLATE_DESC, usage: Lang.TRANSLATE_USAGE, fromMe: false}, (async (message, match) => {
    ...
    Garfield.addXnodes({pattern: 'dettlng$', fromMe: false, desc: dlang_dsc}, (async (message, match) => {
    ...
    Garfield.addXnodes({pattern: 'zbshss (.*)', fromMe: false, desc: Lang.TTS_DESC}, (async (message, match) => {
...
reply = await message.client.sendMessage(message.jid,fs.readFileSync('./' + title + '.jpg'), MessageType.image, { caption: '\n```Title -```\n*'+ title +'*\n```Wait Uploading```' });
    ...
    Garfield.addXnodes({pattern: 'vijdjo ?(.*)', fromMe: false, desc: Lang.VIDEO_DESC}, (async (message, match) => { 
    ...
    Garfield.addXnodes({pattern: 'ythsh ?(.*)', fromMe: false, desc: Lang.YT_DESC}, (async (message, match) => { 
    ...
    Garfield.addXnodes({pattern: 'wjdjdki ?(.*)', fromMe: false, desc: Lang.WIKI_DESC}, (async (message, match) => { 
    ...
    Garfield.addXnodes({pattern: 'sjsjd ?(.*)', fromMe: false, desc: Lang.IMG_DESC}, (async (message, match) => { 
        ...
        if (match[1] === '') return await message.client.sendMessage(message.jid,Lang.NEED_WORDS,MessageType.text);
        gis(match[1], async (error, result) => {
            for (var i = 0; i < (result.length < 7 ? result.length : 5); i++) {
                var get = got(result[i].url, {https: {rejectUnauthorized: false}});
                var stream = get.buffer();
    ...
    Garfield.addXnodes({ pattern: 'github ?(.*)', fromMe: false, desc: Glang.GİTHUB_DESC }, async (message, match) => {
    ...
    Garfield.addXnodes({pattern: 'lyric ?(.*)', fromMe: false, desc: Slang.LY_DESC }, (async (message, match) => {
    ...
    Garfield.addXnodes({pattern: "xxxxx ?(.*)", fromMe: false, desc: Clang.COV_DESC}, (async (message, match) => {
        if (match[1] === "") {
            try{
                //const resp = await fetch("https://coronavirus-19-api.herokuapp.com/all").then(r => r.json());
                const respo = await got("https://coronavirus-19-api.herokuapp.com/all").then(async ok => {
